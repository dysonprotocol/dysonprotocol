...
// file.
func (app *DysApp) ExportAppStateAndValidators(forZeroHeight bool, jailAllowedAddrs, modulesToExport []string) (servertypes.ExportedApp, error) {
...
func (app *DysApp) prepForZeroHeightGenesis(ctx sdk.Context, jailAllowedAddrs []string) {
